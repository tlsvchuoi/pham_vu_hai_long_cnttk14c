...
public class ManChoiKho extends AppCompatActivity {
    ...
    CountDownTimer tm = new CountDownTimer(1000, 10) {
        @Override
    ...
    private void connect() {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(ManChoiKho.this);
    ...
    private void setData() {
        ...
        Adapter adapter = new Adapter(ManChoiKho.this, R.layout.activity_man_choi, arr);
