...
public class ManChoi extends AppCompatActivity {
    ...
    private void setData() {
        ...
        Adapter adapter = new Adapter(ManChoi.this, R.layout.activity_man_choi, arr);
        ...
        gvMau.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == sp.result && check == 0) {
                    ...
                    mediaPlayer = MediaPlayer.create(ManChoi.this, R.raw.dung);
                    mediaPlayer.start();
                } else {
                    mediaPlayer = MediaPlayer.create(ManChoi.this, R.raw.sai);
                    mediaPlayer.start();
                }
            }
        });
